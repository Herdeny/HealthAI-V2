...
# 选择高度可变基因
print(f"Selecting {select_num} highly variable genes...", flush=True)
sc.pp.highly_variable_genes(adata, min_mean=0.0125, max_mean=3, min_disp=0.5, n_top_genes=select_num)
print(f"{select_num} Highly variable genes selected.", flush=True)
# 提取高变基因的表达矩阵
